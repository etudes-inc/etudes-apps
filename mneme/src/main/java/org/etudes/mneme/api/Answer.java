/**********************************************************************************
 *
 * Copyright (c) 2008, 2013, 2017 Etudes, Inc.
 * 
...
public interface Answer {
	...
	/**
	 * Check if the question is answered; if the user has made the answer entries. Answers that have only "mark for review" or a rational are not considered
	 * answered.
	 * 
	...
	/**
	 * Check if this answer should show correct answer in review, based on the assessment setting and answer correctness. For the setting correct_only, this
	 * method check's partial correctness, otherwise complete correctness
	 * 
	...
	/**
	 * Check if this answer should show correct answer in review, based on the assessment setting and answer correctness. Checks for complete correctness in all
	 * settings
	 * 
	 * @return TRUE if the answer should show correct answer in review, FALSE if not.
	 */
