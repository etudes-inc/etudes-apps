/**********************************************************************************
 *
 * Copyright (c) 2008, 2009, 2010, 2011, 2012, 2015, 2017 Etudes, Inc.
 * 
...
public interface QuestionService extends QuestionPoolService, QuestionGetService, QuestionAdminService {
	 ...
	 */
	List<Question> findQuestions(String context, FindQuestionsSort sort, String search, String questionType, Integer pageNum, Integer pageSize, Boolean surveys,
			Boolean valid);
	 ...
	 *            The context.
	 * @param publishedOnly
	 *            if TRUE, read just those questions used by published assessments (the historical ones), otherwise read those used by published and unpublished
	 *            assessments.
	 */
