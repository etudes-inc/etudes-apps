/**********************************************************************************
 *
 * Copyright (c) 2008, 2009, 2010, 2013, 2014, 2015, 2017 Etudes, Inc.
 * 
...
public interface AttachmentService {
	 ...
	 * @return The Reference to the added attachment.
	 */
	Reference addAttachment(String application, String context, String prefix, NameConflictResolution onConflict, Reference resource, boolean makeThumb,
			String altRef);
	...
	/**
	 * Add an attachment from a byte array using Mneme's default values for all other parameters. Invoked by CK connector for audio files
	 * 
	 * @param context
	 *            The context associated with the attachment.
	 * @param submissionId
