/**********************************************************************************
 *
 * Copyright (c) 2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2017 Etudes, Inc.
 * 
...
public interface Submission {
	 ...
	 * 
	 * @return The TRUE if any of the submissions, including this one, to this same assignment from the same user, are not fully graded and released, FALSE if
	 *         not, or NULL if not known.
	 */
	...
	/**
	 * Check if the submission may be started for an nth attempt - the user must have permission, the submission must be a complete, the sibling count must be
	 * fewer than the assessment's tries limit, and the assessment must be open.
	 * 
	 * @return TRUE if the submission may be started, FALSE if not.
	 */
	...
	/**
	 * Check if the submission may be started for an nth attempt for the given user - the user must have permission, the submission must be a complete, the
	 * sibling count must be fewer than the assessment's tries limit, and the assessment must be open.
	 * 
	 * @param userId
	...
	/**
	 * Check if the submission may be reviewed at some later point - the user must be the submission user, and the submission must be complete and not from a
	 * retracted assessment, and the assessment must be set to eventually allow review.
	 * 
	...
	/**
	 * Set the total score of the submission. The Evaluation will be adjusted so that this becomes the total score given the current answer auto scores and
	 * evaluations.
	 * 
	 * @param score
