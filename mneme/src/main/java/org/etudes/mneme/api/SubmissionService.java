/**********************************************************************************
 *
 * Copyright (c) 2008, 2009, 2010, 2011, 2013, 2014, 2015, 2017 Etudes, Inc.
 * 
...
public interface SubmissionService extends SubmissionUnscoredQuestionService {
	 ...
	 */
	void completeSubmission(Submission submission, Boolean autoComplete)
	 ...
	 * @return A sorted List<Submission> of the submissions for the assessment.
	 */
	List<Submission> findAssessmentSubmissions(Assessment assessment, FindAssessmentSubmissionsSort sort, Boolean official, String allUid, Integer pageNum,
			Integer pageSize, Boolean filterByPermission);
	 ...
	 */
	List<Submission> findAssessmentSubmissions(Assessment assessment, FindAssessmentSubmissionsSort sort, Boolean official, String allUid, Integer pageNum,
			Integer pageSize, Boolean filterByPermission, String sectionFilter);
	 ...
	 * @return A sorted List<Answer> of the answers.
	 */
	List<Answer> findSubmissionAnswers(Assessment assessment, Question question, Boolean official, FindAssessmentSubmissionsSort sort, Integer pageNum,
			Integer pageSize);
	 ...
	 * @param question
	 *            The question.
	 * @return A List containing all the scores for this question from all completed submissions to the question's assessment, or an empty list if there are
	 *         none.
	 */
	 ...
	 * <li>the one (of many for this user) submission that will be the official (graded) (depending on the assessment settings, and submission time and
	 * score)</li>
	 * </ul>
	 * 
	 * @param context
	...
	/**
	 * From the CourseMap, Get the submissions to assessments in this context made by this user. Do not skip hidden items Consider:
	 * <ul>
	 * <li>published and valid assessments</li>
	 * <li>assessments in this context</li>
	 * <li>assessments this user can submit to and have submitted to</li>
	...
	/**
	 * Enter or update an answer to a question of an incomplete submission to an assessment. Auto grade. Updated related info (such as the submission's
	 * score).<br />
	 ...
	 *             if the submission is already completed.
	 */
	void submitAnswer(Answer answer, Boolean completeAnswer, Boolean completeSubmission, Boolean autoComplete)
			throws AssessmentPermissionException, AssessmentClosedException, SubmissionCompletedException;

	/**
	 * Enter or update a set of answers to questions of an incomplete submission to an assessment. Auto grade. Updated related info (such as the submission's
	 * score).<br />
	 * Complete the submission if indicated.
	 * 
	 * @param answers
